...
const CartDropDown: FC<CartDropDownProps> = () => {
    ...
    return (    
<>
{cart.length!=0 ? ( <table className="navbarCartTable text-center mt-5">
    <thead>
      <tr>
  ...
  </table>):(<div className="d-flex align-items-center flex-column ">
 <h4>your Cart is empty</h4>
  <img height={250} src="https://cdn-icons-png.flaticon.com/512/11329/11329060.png" alt="" />
  </div>)}
</>
